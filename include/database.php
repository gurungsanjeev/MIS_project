...
// 	function executeQuery($params = array()) {
// 		$stmt = mysqli_prepare($this->conn, $this->sql_string);
...
// 	}
// //end
// $params = array(97 /* other parameters */);
// $mydb->setQuery("UPDATE tblorder SET column1=?, column2=? WHERE ORDERNUMBER=?");
// $result = $mydb->executeQuery($params);
// //almost finish
